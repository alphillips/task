      ...
      <div className="uikit-grid main-paper" style={{ padding: 9 }}>
        <div className="row">
          ...
          <div className="col-md-10" style={styles.wrapper}>
            {quickLinksOptions_Pending.map(quickLink => (
              <Chip backgroundColor={cyan50} onClick={this.handleClick(quickLink.value)} style={styles.chip}>
                <a href="#"> {quickLink.label}</a>
              </Chip>
            ))}
            {quickLinksOptions_Completed.map(quickLink => (
              <Chip onClick={this.handleClick(quickLink.value)} style={styles.chip}>
                <a href="#"> {quickLink.label}</a>
              </Chip>
            ))}
          </div>
        ...
        <div className="row">
          ...
          <div className="col-md-1">
            {" "}
            <a href="#" onClick={this.props.toggleQuickLink()}>
              close
            </a>{" "}
          </div>
        </div>
