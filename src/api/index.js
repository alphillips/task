const URL_BASE_ORIG = (process.env.API_HOST || "") + URL_BASE + "/api/";

const DEV_URL_BASE = "http://act001appd0001.devagdaff.gov.au:9001";
...
//mail
const URL_BASE2 = URL_BASE + "/message-rest-ui/api/";
const URL_BASE3 = URL_BASE + "/inbox-rest-ui/api/";
