    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        !this.state.messagesSectionOpened && _react2.default.createElement(
          ...
          this.state.showReviewButton && _react2.default.createElement(
            "div",
      ...
      window.IS_STAFF && this.state.task && this.state.task.serviceRequestId && this.state.task.serviceRequestId.length > 0 && _react2.default.createElement(_TaskCorrespondences2.default, {
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_input2.default, { label: "Reason", value: this.state.taskActionReason, onChange: this.onChange("taskActionReason"), rows: 2, multiLine: true, maxlength: "1900", id: "taskActionReason" }),
        _react2.default.createElement(
          "div",
          { className: "btn-group" },
          _react2.default.createElement(
